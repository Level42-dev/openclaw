  ...
  return html`
    <div class="sw-header-controls">
      <div
        ...
        role="tablist"
        aria-label=${t("skillWorkshop.viewLabel")}
      ...
      >
        <button
          ...
          title=${t("skillWorkshop.boardView")}
        ...
        >
          ...
          <span>${t("skillWorkshop.board")}</span>
        </button>
        <button
          type="button"
          ...
          title=${t("skillWorkshop.todayView")}
        ...
        >
          ...
          <span>${t("skillWorkshop.today")}</span>
        </button>
