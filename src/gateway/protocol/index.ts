...
import {
  ...
  type TalkRealtimeRelayCommitParams,
  TalkRealtimeRelayCommitParamsSchema,
...
export const validateTalkRealtimeRelayCommitParams = ajv.compile<TalkRealtimeRelayCommitParams>(
  TalkRealtimeRelayCommitParamsSchema,
);
